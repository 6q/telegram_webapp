    ...
    if(!empty($dbBotId))
	{
       ...
       // file_put_contents(public_path().'/result.txt',serialize($keyboard));
        ...
        if(!empty($messageText) && $messageText == $autoresponse){
            ...
            $db_autoresponse = DB::table('autoresponses')->orderBy('sort_order','ASC')->orderBy('submenu_heading_text','ASC')->where('type_id', '=', $dbBotId)->get();
            ...
            */
            ...
            $db_contact_form = DB::table('contact_forms')->orderBy('sort_order','ASC')->orderBy('submenu_heading_text','ASC')->where('type_id', '=', $dbBotId)->get();
            ...
            $db_galleries = DB::table('galleries')->orderBy('sort_order','ASC')->orderBy('gallery_submenu_heading_text','ASC')->where('type_id', '=', $dbBotId)->get();
            ...
            $db_chanels = DB::table('chanels')->orderBy('sort_order','ASC')->orderBy('chanel_submenu_heading_text','ASC')->where('type_id', '=', $dbBotId)->get();
