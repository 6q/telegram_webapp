...
--
-- Host: localhost
-- Generation Time: Sep 24, 2016 at 11:11 AM
...
--
-- Table structure for table `autoresponses`
--
...
--
-- Dumping data for table `autoresponses`
--
...
(1, 'bot', 1, 6, 'sdg', 'fsg', '', '2016-08-10 11:26:22', '2016-08-10 11:26:22'),
(2, 'bot', 1, 6, 'fhgxfhdgxj', '', '1470828412_7.png', '2016-08-10 11:26:52', '2016-08-10 11:26:52');
...
(1, 6, 'cus_8y7mym0JFDPJkB', 'bhupesh', 'stn', 'sadgawsg', 'sfgsfhgsfh', '1470654206_7.png', 'sd sfh sfdh sdh', 'sf hgdhdgh', 'dxfhcj', 'xdgjfg', 'jfgjfg', 'jfddfj', '2016-08-08 11:03:26', '2016-08-08 11:03:28'),
(2, 6, 'cus_8y89Bd1K9jBU2K', 'bhupesh', 'stn', 'sadgsg', 'sgfshg', '1470655599_7.png', 'sfh df', 'hsdfhdshd', 'sfhsdfhadf', 'hsdfjhdxfhjdfhs', 'dhjdgjdgj', 'fdhfdhdfhdh', '2016-08-08 11:26:39', '2016-08-08 11:26:41'),
(3, 6, 'cus_94V4Kk5C1yOn4V', 'bhupesh', 'stn', 'test', 'test', '1472124674_4.png', '', '', '', '', '', '', '2016-08-25 11:31:14', '2016-08-25 11:31:18');
...
CREATE TABLE `bot_messages` (
  ...
  `bot_id` bigint(20) DEFAULT NULL COMMENT 'Unique chat identifier',
  `bot_user_id` bigint(20) DEFAULT NULL COMMENT 'Unique user identifier',
...
(1, 'bot', 2, 6, 'sdg', 'sfg', '', '2016-08-22 06:05:39', '2016-08-22 06:05:39');
...
INSERT INTO `contact_forms` (`id`, `types`, `type_id`, `submenu_heading_text`, `user_id`, `headline`, `created_at`, `updated_at`) VALUES
(1, 'bot', 1, NULL, 6, 'sfhgsfzhs', '2016-08-11 09:53:30', '2016-08-11 09:53:30');

-- --------------------------------------------------------

--
-- Table structure for table `contact_form_questions`
--

CREATE TABLE `contact_form_questions` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `contact_form_questions`
--
...
INSERT INTO `email_templates` (`id`, `title`, `subject`, `description`, `from`, `reply_to_email`, `status`, `is_html`, `created_at`, `updated_at`) VALUES
(4, 'forgot_password', 'Forgot password request from ##SITE_NAME##', '<div style="padding: 10px; width: 720px; margin: auto;">\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n  <tbody><tr>\r\n    <td align="center">\r\n      <p style="text-align: center; font-size: 11px; color: rgb(146, 146, 146); margin: 3px;">\r\n        Be sure to add\r\n        <a href="mailto:##FROM_EMAIL##" style="color: rgb(9, 129, 190);" title="Add ##FROM_EMAIL## to your whitelist" target="_blank">##FROM_EMAIL##</a>\r\n        to your address book or safe sender list so our emails get to your inbox.\r\n      </p>\r\n    </td>\r\n  </tr>\r\n</tbody></table>\r\n<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid rgb(74, 136, 51); background-color: rgb(93, 170, 64);">\r\n  <table style="background-color: rgb(255, 255, 255);" width="100%">\r\n    <tbody><tr>\r\n      <td align="center">\r\n        <div style="padding: 12px; margin: 0pt 30px; border-bottom: 1px solid rgb(214, 214, 214);">\r\n          <a href="##SITE_LINK##" style="color: rgb(255, 255, 255);" title="##SITE_NAME##" target="_blank"><img alt="[Image: ##SITE_NAME##]" src="##SITE_LOGO##"></a>\r\n        </div>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td style="padding: 20px 30px 5px;">\r\n        <h2 style="color: rgb(84, 84, 84); margin: 0pt 20px 5px; font-family: Helvetica,Arial,sans-serif; font-size: 18px;">\r\n          Hi\r\n         ##USERNAME##,\r\n        </h2>\r\n        <p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">A forgot password request has been made for your user account at ##SITE_NAME##. Please use the below details to login in website</p>\r\n       <p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Email: ##USER_EMAIL##</p>       \r\n		<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Password: ##USER_PASSWORD##</p>      \r\n        \r\n      \r\n        <p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">  If you did not request this action and feel this is an error, please contact us at ##SUPPORT_EMAIL##.</p>\r\n        <p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;"></p></td>\r\n    </tr>\r\n    <tr>\r\n      <td>\r\n        <div style="border-top: 1px solid rgb(214, 214, 214); padding: 15px 30px 25px; margin: 0pt 30px;">\r\n          <h4 style="font-family: Helvetica,Arial,sans-serif; font-size: 22px; font-weight: 700; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: rgb(99, 164, 232);">\r\n            Thanks,\r\n          </h4>\r\n          <h5 style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;">\r\n            ##SITE_NAME## -\r\n            <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" title="##SITE_NAME## - Collective Buying Power" target="_blank">##SITE_LINK##</a>\r\n          </h5>\r\n        </div>\r\n      </td>\r\n    </tr>\r\n  </tbody></table>\r\n  <table style="margin-top: 2px; background-color: rgb(230, 243, 224);" width="100%">\r\n    <tbody><tr>\r\n      <td>\r\n        <p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); font-weight: 700; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;">\r\n          Need help? Have feedback? Feel free to\r\n          <a href="##CONTACT_URL##" title="Contact ##SITE_NAME##" target="_blank">Contact Us</a>\r\n        </p>\r\n      </td>\r\n    </tr>\r\n  </tbody></table>\r\n</div>\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n  <tbody><tr>\r\n    <td align="center">\r\n      <p style="font-size: 11px; color: rgb(146, 146, 146); margin: 3px; padding-top: 10px;">\r\n        Delivered by\r\n        <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" title="##SITE_NAME##" target="_blank">##SITE_NAME##</a></p>\r\n    </td>\r\n  </tr>\r\n</tbody>\r\n\r\n</table>\r\n  </div>', '##FROM_EMAIL##', '##REPLY_TO_EMAIL##', 1, 1, '2012-10-08 05:58:12', '2013-10-07 12:27:06'),
(6, 'Register confirmation  Request', 'Register confirmation  Request from  ##SITE_NAME## account', '<div style="padding: 10px; width: 720px; margin: auto;">\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="text-align: center; font-size: 11px; color: rgb(146, 146, 146); margin: 3px;">Be sure to add <a href="mailto:##FROM_EMAIL##" style="color: rgb(9, 129, 190);" target="_blank" title="Add ##FROM_EMAIL## to your whitelist">##FROM_EMAIL##</a> to your address book or safe sender list so our emails get to your inbox.</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid rgb(74, 136, 51); background-color: rgb(93, 170, 64);">\r\n<table style="background-color: rgb(255, 255, 255);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<div style="padding: 12px; margin: 0pt 30px; border-bottom: 1px solid rgb(214, 214, 214);"><a href="##SITE_LINK##" style="color: rgb(255, 255, 255);" target="_blank" title="##SITE_NAME##"><img alt="logo" src="##SITE_LOGO##" /></a></div>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style="padding: 20px 30px 5px;">\r\n			<h2 style="color: rgb(84, 84, 84); margin: 0pt 20px 5px; font-family: Helvetica,Arial,sans-serif; font-size: 18px;">Hi ##USERNAME##,</h2>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">You have successfully registered on <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME## - Collective Buying Power">##SITE_NAME##</a>Your login details are :<br />\r\n			Email: ##EMAIL##<br />\r\n			Password: ##PASSWORD##</p>\r\n\r\n			<p>Please complete your registration to activate your account</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td>\r\n			<div style="border-top: 1px solid rgb(214, 214, 214); padding: 15px 30px 25px; margin: 0pt 30px;">\r\n			<h4 style="font-family: Helvetica,Arial,sans-serif; font-size: 22px; font-weight: 700; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: rgb(99, 164, 232);">Thanks,</h4>\r\n\r\n			<h5 style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;">##SITE_NAME## - <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME## - Collective Buying Power">##SITE_LINK##</a></h5>\r\n			</div>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<table style="margin-top: 2px; background-color: rgb(230, 243, 224);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td>\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); font-weight: 700; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;">Need help? Have feedback? Feel free to <a href="##CONTACT_URL##" target="_blank" title="Contact ##SITE_NAME##">Contact Us</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="font-size: 11px; color: rgb(146, 146, 146); margin: 3px; padding-top: 10px;">Delivered by <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME##">##SITE_NAME##</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', '##FROM_EMAIL##', '##REPLY_TO_EMAIL##', 0, 1, '2012-10-22 09:10:36', '2015-02-19 14:10:04'),
(7, 'Welcome Email', 'Welcome to ##SITE_NAME##', '<div style="padding: 10px; width: 720px; margin: auto;">\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="text-align: center; font-size: 11px; color: rgb(146, 146, 146); margin: 3px;">Be sure to add <a href="mailto:##FROM_EMAIL##" style="color: rgb(9, 129, 190);" target="_blank" title="Add ##FROM_EMAIL## to your whitelist">##FROM_EMAIL##</a> to your address book or safe sender list so our emails get to your inbox.</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid rgb(74, 136, 51); background-color: rgb(93, 170, 64);">\r\n<table style="background-color: rgb(255, 255, 255);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<div style="padding: 12px; margin: 0pt 30px; border-bottom: 1px solid rgb(214, 214, 214);"><a href="##SITE_LINK##" style="color: rgb(255, 255, 255);" target="_blank" title="##SITE_NAME##"><img alt="logo" src="##SITE_LOGO##" /></a></div>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style="padding: 20px 30px 5px;">\r\n			<h2 style="color: rgb(84, 84, 84); margin: 0pt 20px 5px; font-family: Helvetica,Arial,sans-serif; font-size: 18px;">Hi ##USERNAME##,</h2>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">We wish to say a quick hello and thanks for registering at ##SITE_NAME##.</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">If you did not request this account and feel this is an error, please contact us at ##SUPPORT_EMAIL##.</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;">&nbsp;</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td>\r\n			<div style="border-top: 1px solid rgb(214, 214, 214); padding: 15px 30px 25px; margin: 0pt 30px;">\r\n			<h4 style="font-family: Helvetica,Arial,sans-serif; font-size: 22px; font-weight: 700; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: rgb(99, 164, 232);">Thanks,</h4>\r\n\r\n			<h5 style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;">##SITE_NAME## - <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME## - Collective Buying Power">##SITE_LINK##</a></h5>\r\n			</div>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<table style="margin-top: 2px; background-color: rgb(230, 243, 224);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td>\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); font-weight: 700; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;">Need help? Have feedback? Feel free to <a href="##CONTACT_URL##" target="_blank" title="Contact ##SITE_NAME##">Contact Us</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="font-size: 11px; color: rgb(146, 146, 146); margin: 3px; padding-top: 10px;">Delivered by <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME##">##SITE_NAME##</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', '##FROM_EMAIL##', '##REPLY_TO_EMAIL##', 0, 1, '2012-10-22 09:38:41', '2015-02-19 14:09:54'),
(10, 'contact_us', 'Contact Us Enquiry on ##SITE_NAME##', '<div style="padding: 10px; width: 720px; margin: auto;">\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="text-align: center; font-size: 11px; color: rgb(146, 146, 146); margin: 3px;">Be sure to add <a href="mailto:##FROM_EMAIL##" style="color: rgb(93, 170, 64);" target="_blank" title="Add ##FROM_EMAIL## to your whitelist">##FROM_EMAIL##</a> to your address book or safe sender list so our emails get to your inbox.</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid rgb(74, 136, 51); background-color: rgb(93, 170, 64);">\r\n<table style="background-color: rgb(255, 255, 255);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<div style="padding: 12px; margin: 0pt 30px; border-bottom: 1px solid rgb(214, 214, 214);"><a href="##SITE_LINK##" style="color: rgb(255, 255, 255);" target="_blank" title="##SITE_NAME##"><img alt="[Image: ##SITE_NAME##]" src="##SITE_LOGO##" /></a></div>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style="padding: 20px 30px 5px;">\r\n			<h2 style="color: rgb(84, 84, 84); margin: 0pt 20px 5px; font-family: Helvetica,Arial,sans-serif; font-size: 18px;">Hi Admin,</h2>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">A contact enquiry is posted on ##SITE_NAME##. Please review the below contact details.</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Email: ##USER_EMAIL##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">First Name : ##USER_FIRST_NAME##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Last Name : ##USER_LAST_NAME##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Message : ##USER_MESSAGE##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">If you did not request this action and feel this is an error, please contact us at ##SUPPORT_EMAIL##.</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;">&nbsp;</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td>\r\n			<div style="border-top: 1px solid rgb(214, 214, 214); padding: 15px 30px 25px; margin: 0pt 30px;">\r\n			<h4 style="font-family: Helvetica,Arial,sans-serif; font-size: 22px; font-weight: 700; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: rgb(93, 170, 64);">Thanks,</h4>\r\n\r\n			<h5 style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;">##SITE_NAME## - <a href="##SITE_LINK##" style="color: rgb(93, 170, 64);" target="_blank" title="##SITE_NAME## - Collective Buying Power">##SITE_LINK##</a></h5>\r\n			</div>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<table style="margin-top: 2px; background-color: rgb(230, 243, 224);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td>\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); font-weight: 700; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;">Need help? Have feedback? Feel free to <a href="##CONTACT_URL##" style="color: rgb(93, 170, 64);" target="_blank" title="Contact ##SITE_NAME##">Contact Us</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="font-size: 11px; color: rgb(146, 146, 146); margin: 3px; padding-top: 10px;">Delivered by <a href="##SITE_LINK##" style="color: rgb(93, 170, 64);" target="_blank" title="##SITE_NAME##">##SITE_NAME##</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', '##FROM_EMAIL##', '##REPLY_TO_EMAIL##', 0, 1, '2013-10-07 12:31:10', '2015-02-19 14:09:46'),
(30, 'User Info', 'Welcome ##SITE_NAME##', '<div style="padding: 10px; width: 720px; margin: auto;">\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="text-align: center; font-size: 11px; color: rgb(146, 146, 146); margin: 3px;">Be sure to add <a href="mailto:##FROM_EMAIL##" style="color: rgb(9, 129, 190);" target="_blank" title="Add ##FROM_EMAIL## to your whitelist">##FROM_EMAIL##</a> to your address book or safe sender list so our emails get to your inbox.</p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<div style="width: 670px; margin: 5px 0pt; padding: 20px; background-repeat: no-repeat; border: 5px solid rgb(74, 136, 51); background-color: rgb(93, 170, 64);">\r\n<table style="background-color: rgb(255, 255, 255);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<div style="padding: 12px; margin: 0pt 30px; border-bottom: 1px solid rgb(214, 214, 214);"><a href="##SITE_LINK##" style="color: rgb(255, 255, 255);" target="_blank" title="##SITE_NAME##"><img alt="[Image: ##SITE_NAME##]" src="##SITE_LOGO##" /></a></div>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style="padding: 20px 30px 5px;">\r\n			<h2 style="color: rgb(84, 84, 84); margin: 0pt 20px 5px; font-family: Helvetica,Arial,sans-serif; font-size: 18px;">Hi ##USERNAME##,</h2>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">&nbsp;Please use the below details to login in website</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Email: ##USER_EMAIL##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">Password: ##USER_PASSWORD##</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: left; padding: 15px 0px;">&nbsp;</p>\r\n\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;">&nbsp;</p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td>\r\n			<div style="border-top: 1px solid rgb(214, 214, 214); padding: 15px 30px 25px; margin: 0pt 30px;">\r\n			<h4 style="font-family: Helvetica,Arial,sans-serif; font-size: 22px; font-weight: 700; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: rgb(99, 164, 232);">Thanks,</h4>\r\n\r\n			<h5 style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;">##SITE_NAME## - <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME## - Collective Buying Power">##SITE_LINK##</a></h5>\r\n			</div>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<table style="margin-top: 2px; background-color: rgb(230, 243, 224);" width="100%">\r\n	<tbody>\r\n		<tr>\r\n			<td>\r\n			<p style="font-family: Helvetica,Arial,sans-serif; color: rgb(84, 84, 84); font-weight: 700; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;">Need help? Have feedback? Feel free to <a href="##CONTACT_URL##" target="_blank" title="Contact ##SITE_NAME##">Contact Us</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n\r\n<table cellpadding="0" cellspacing="0" width="720px">\r\n	<tbody>\r\n		<tr>\r\n			<td align="center">\r\n			<p style="font-size: 11px; color: rgb(146, 146, 146); margin: 3px; padding-top: 10px;">Delivered by <a href="##SITE_LINK##" style="color: rgb(9, 129, 190);" target="_blank" title="##SITE_NAME##">##SITE_NAME##</a></p>\r\n			</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', '##FROM_EMAIL##', '##REPLY_TO_EMAIL##', 1, 1, '2014-12-26 15:02:39', '2015-02-19 14:48:11');
...
(1, 'bot', 1, 6, 'dghdgh', 'dghdxhgdhf', '2016-08-13 06:26:08', '2016-08-13 06:26:08'),
(2, 'bot', 1, 6, 'gfbj', 'ghj', '2016-08-15 08:52:42', '2016-08-15 08:52:42');
...
--
-- Dumping data for table `my_channels`
--

INSERT INTO `my_channels` (`id`, `user_id`, `stripe_customer_id`, `name`, `description`, `share_link`, `created_at`, `updated_at`) VALUES
(1, 6, 'cus_9Fh2IETaeyDFxM', 'as', 'adsfadsfasdfadsf', 'asdfasdfdasfasdf', '2016-09-24 03:06:20', '2016-09-24 03:06:22'),
(2, 6, 'cus_9FhYPMHz59LdMJ', 'as', 'adsfasdf', 'asdfadsfasdf', '2016-09-24 03:38:53', '2016-09-24 03:38:56');
...
INSERT INTO `pages` (`id`, `title`, `content`, `meta_title`, `meta_description`, `meta_keyword`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Privacy Policy', 'Privacy Policy', '', '', '', 1, '2015-02-20 13:53:07', '2015-04-09 11:04:30'),
(2, 'About Us', '<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas posuere, ligula quis aliquam fringilla, justo lorem fermentum nisi, vitae aliquam mauris sapien et metus. Suspendisse eu ipsum. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos hymenaeos. Sed dapibus lorem ut enim. Praesent auctor metus id enim. Phasellus sit amet ligula vel metus bibendum tristique. Nulla vehicula suscipit ipsum. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Fusce nisi nisi, tristique nec, commodo pulvinar, suscipit a, sapien. In turpis nisl, tempor sed, consequat non, tempor non, turpis. Curabitur mauris velit, interdum et, nonummy vitae, venenatis vitae, orci.</p>\r\n', '', '', '', 1, '2015-04-09 11:06:14', '2015-04-10 21:36:01'),
(7, 'Contact Us', '<p>Contact Us</p>\r\n', '', '', '', 1, '2015-04-09 11:08:51', '2015-04-09 11:08:51'),
(9, 'Term & Condition', '<p>Term &amp; Condition</p>\r\n', '', '', '', 1, '2015-04-09 11:09:58', '2015-04-09 11:09:58'),
(11, 'Welcome', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sit amet semper ipsum. Vivamus eu elit non lectus luctus venenatis vitae nec odio. In pulvinar fringilla ex, at iaculis nisi posuere non. Donec rhoncus sem finibus, malesuada turpis sed, fringilla nisi. Vestibulum condimentum massa at erat lacinia malesuada. Nam facilisis dictum eros eu rutrum. Donec sed porta augue. Vestibulum aliquam lacus in dapibus interdum. Suspendisse fringilla auctor dolor, nec gravida magna convallis in. Vestibulum varius arcu sagittis ipsum elementum aliquet. Ut luctus arcu viverra, malesuada felis non, gravida lorem. Proin id sapien condimentum, venenatis justo vitae, pulvinar ante. Etiam tempus, felis in ullamcorper rutrum, purus magna egestas libero, rutrum condimentum purus nibh tristique massa. Nulla tortor felis, ultrices sit amet felis sed, eleifend vehicula leo. Integer facilisis turpis vel ligula sodales, quis dignissim ipsum interdum.</p>\r\n\r\n<p>Proin vel mattis libero. Phasellus et placerat nibh, ac finibus lacus. In ac sem a dui tristique semper vel sodales nulla. Nunc fermentum at ante ac varius. Nunc et nisi sit amet risus dictum sodales vitae a turpis. Aliquam urna ante, mattis vel ex quis, commodo faucibus eros. Nunc in tincidunt erat. Donec mattis mollis consequat. Pellentesque ac lobortis odio, in gravida massa. Maecenas sagittis lorem tellus. Nullam lacinia magna quis est consequat vulputate.</p>\r\n\r\n<p>Morbi facilisis mollis sapien, at lacinia neque vulputate sit amet. Nunc nec dictum orci. Proin ut varius felis. Aliquam nec mauris dapibus, pharetra nunc a, fermentum elit. Maecenas in libero ipsum. Aenean at dictum magna. Mauris sagittis sit amet mauris suscipit sagittis. Nunc mattis pellentesque viverra.</p>\r\n\r\n<p>Etiam porttitor dolor non nisl varius, sit amet placerat eros semper. Morbi magna nisi, cursus et molestie id, commodo eget felis. Cras mattis est vel ipsum porta congue. Cras tempor eros sapien, consectetur dapibus arcu vestibulum eget. Mauris lobortis tellus a placerat tristique. Phasellus maximus vestibulum lorem, id facilisis mi blandit ac. Suspendisse vel risus aliquet quam imperdiet aliquam. Praesent semper justo ut ligula luctus, sed interdum erat gravida. Nullam sodales, urna at fermentum facilisis, lorem mi porttitor neque, ac euismod risus lorem nec est. Duis elementum mi et nibh mollis, in dignissim risus aliquam. Nunc gravida nisi eu aliquet lobortis. Etiam vitae nisl eget massa aliquam auctor. Nullam eleifend magna luctus orci eleifend semper. Nam pretium orci suscipit, laoreet arcu a, faucibus sem. Nam diam tortor, pretium ac neque nec, vehicula faucibus ipsum. Suspendisse non nisi lectus.</p>\r\n\r\n<p>Aliquam ullamcorper at neque nec commodo. Fusce volutpat arcu a dictum imperdiet. Nulla at mi sit amet odio tincidunt hendrerit. Sed eu augue luctus, elementum ex et, placerat ipsum. Suspendisse vel diam porttitor, molestie nibh sed, sollicitudin ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor purus sed tortor ultricies, eget sagittis velit sagittis.</p>\r\n', 'Welcome', 'Welcome', 'Welcome', 1, '2016-09-02 12:36:25', '2016-09-02 12:36:25');
...
(2, 'admin', '', 'admin@admin.com', '$2y$10$uDsQetfDdnW9P23JvFCI5O4O1z9CaGBFCx/HGup.67PLoQgA5WYAW', 1, 1, 0, 0, 1, NULL, 0, '', '', '', '', '', '', '2016-06-20 18:30:00', '2016-09-09 03:05:38', 'LUg5EYnPvpg0VcReyLcsBLwrCUItsi4rvkcdslK11PBo3VzUyFRMF1ZCFLeE', ''),
...
(6, 'bhupesh', 'stn', 'bhupesh@searchtechnow.com', '$2y$10$uDsQetfDdnW9P23JvFCI5O4O1z9CaGBFCx/HGup.67PLoQgA5WYAW', 2, 1, 0, 0, 1, '99OQxYEhbtZFsSOndAfwJKCP9aBzVD', 99, '302020', '1470736142_4.png', '', '', '', '', '2016-07-28 23:29:12', '2016-09-11 23:09:59', 'OkPUsPVnrf6jdKLOBMkKLfWxsJXHLx6i02jh3lY8wUkAzqmCADrhiJToEmKT', '7897897899');
...
(1, 3, 'test address', '323', 99, 1501, 'jaipur', '34223', '2016-06-24 01:06:07', '2016-06-24 01:06:07'),
(2, 6, '', 'name', 1, 2, 'jaipur', '302012', '2016-09-24 09:08:54', '2016-09-24 09:08:54');
...
(1, 6, 7, 'bot', 1, '12.00', '2016-08-08', '2016-09-08', '2016-08-08 00:00:00', 'Completed', '2016-08-08 11:03:29', '2016-08-08 11:03:29'),
(2, 6, 7, 'bot', 2, '12.00', '2016-08-08', '2016-09-08', '2016-08-08 00:00:00', 'Completed', '2016-08-08 11:26:41', '2016-08-08 11:26:41'),
(3, 6, 7, 'bot', 3, '50.00', '2016-08-25', '2016-11-25', '2016-08-25 00:00:00', 'Completed', '2016-08-25 11:31:19', '2016-08-25 11:31:19'),
(4, 6, 7, 'Channel', 0, '50.00', '2016-09-24', '2016-12-24', '2016-09-24 00:00:00', 'Completed', '2016-09-24 07:32:10', '2016-09-24 07:32:10'),
(5, 6, 7, 'Channel', 1, '50.00', '2016-09-24', '2016-12-24', '2016-09-24 00:00:00', 'Completed', '2016-09-24 08:36:22', '2016-09-24 08:36:22'),
(6, 6, 6, 'Channel', 2, '12.00', '2016-09-24', '2016-10-24', '2016-09-24 00:00:00', 'Completed', '2016-09-24 09:08:56', '2016-09-24 09:08:56');
...
(1, 6, 6, 'bot', 1, '12.00', '', '2016-08-08 11:03:29', '2016-08-08 11:03:29'),
(2, 6, 6, 'bot', 2, '12.00', '', '2016-08-08 11:26:41', '2016-08-08 11:26:41'),
(3, 6, 7, 'bot', 3, '50.00', '', '2016-08-25 11:31:19', '2016-08-25 11:31:19'),
(4, 6, 7, 'Channel', 0, '50.00', '', '2016-09-24 07:32:10', '2016-09-24 07:32:10'),
(5, 6, 7, 'Channel', 1, '50.00', '', '2016-09-24 08:36:23', '2016-09-24 08:36:23'),
(6, 6, 6, 'Channel', 2, '12.00', '', '2016-09-24 09:08:56', '2016-09-24 09:08:56');
...
--
-- Indexes for table `autoresponses`
--
...
--
-- Indexes for table `contact_form_questions`
--
...
ALTER TABLE `email_templates`
  ADD UNIQUE KEY `email_templates_pk` (`id`);
...
--
-- Indexes for table `my_channels`
--
ALTER TABLE `my_channels`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `autoresponses`
--
ALTER TABLE `autoresponses`
...
ALTER TABLE `contact_forms`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `contact_form_questions`
--
ALTER TABLE `contact_form_questions`
...
--
-- AUTO_INCREMENT for table `my_channels`
--
ALTER TABLE `my_channels`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
