...
return [
	...
	*/
	...
	"not_in"               => "Aquest camp no és correcte.",
	"numeric"              => "Aquest camp ha de ser un número.",
	"regex"                => "Aquest camp  no té un format correcte.",
	"required"             => "Aquest camp és requerit.",
	"required_if"          => "Aquest camp és requerit quan :other és :value.",
	"required_with"        => "Aquest camp és requerit quan :values és present.",
	"required_with_all"    => "Aquest camp és requerit quan :values és present.",
	"required_without"     => "Aquest camp és requerit quan :values no és present.",
	"required_without_all" => "Aquest camp és requerit quan no :values és present.",
	"same"                 => "Aquest camp i :other han de coincidir.",
	"size"                 => [
		"numeric" => "Aquest camp ha de tenir :size.",
		"file"    => "Aquest camp ha de tenir :size Kb.",
		"string"  => "Aquest camp ha de ternir :size caràcters.",
		"array"   => "Aquest camp ha de tenir :size ítems.",
	],
	"unique"               => "Aquest camp ja està agafat.",
	"url"                  => "Aquest camp no és correcte.",
    "tags"                 => "tags separats per comes (sense espais) i un màxim de 50 caràcters.",
