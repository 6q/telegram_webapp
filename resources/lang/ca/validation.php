...
return [
	...
	*/
	...
	"regex"                => ":attribute  no té un format correcte.",
	"required"             => ":attribute és requerit.",
	"required_if"          => ":attribute és requerit quan :other és :value.",
	"required_with"        => ":attribute és requerit quan :values és present.",
	"required_with_all"    => ":attribute és requerit quan :values és present.",
	"required_without"     => ":attribute és requerit quan :values no és present.",
	"required_without_all" => ":attribute és requerit quan no :values és present.",
