                ...
                <ul class="show_hide_ul">
                    ...
                    <li class="browse_content">
                        <label>
							...
							?>
                            <div id="image-holder"><a href="javascript:void(0);" class="close_button"
                                                      onclick="rmv('0')">X</a>{!! HTML::image('uploads/'.$autoresponses[0]->image) !!}
                            </div>
							<?php
							}
							else{
                    ...
                    <li class="input_submit buy_now new_submit">
                        <a type="button" class="btn btn-info" href="{!! URL::to('/bot/detail/'.$autoresponses[0]->type_id) !!}"><i class="fa fa-backward" aria-hidden="true"></i></a>
                        <a type="button" class="btn btn-danger"
                           onclick="return warnBeforeRedirect('{!! URL::to('/command/autoresponse_delete/'.$autoresponses[0]->type_id.'/'.$autoresponses[0]->id) !!}')"><i
