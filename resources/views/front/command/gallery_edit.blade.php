                            ...
                            <ul id="preview">
                                ...
                                <li id="<?php echo $i; ?>">
                                    <a href="javascript:void(0);" class="close_button"
                                       onclick="rmv('<?php echo $i; ?>')">X</a><span><img
                                                src="{{ URL::to('/') }}/uploads/<?php echo $v1->image; ?>"/></span>
                                    <b>{!! trans('front/command.button') !!}</b>: <input type="text"
                                                                                         name="title[<?php echo $v1->image . '_' . $i; ?>]"
                                                                                         value="<?php echo $v1->title; ?>"
                                                                                         placeholder="{!! trans('front/command.button') !!}"
                                                                                         required/><br>
                                    <b>{!! trans('front/command.description') !!}</b>: <br><textarea type="text"
                                                                                                     name="description[<?php echo $v1->image . '_' . $i; ?>]"
                                                                                                     placeholder="{!! trans('front/command.description') !!}"
                                                                                                     maxlength="200"><?php echo $v1->description; ?></textarea>
                                </li>
								<?php
								$i++;
								}
