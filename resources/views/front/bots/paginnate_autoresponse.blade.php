    ...
    <tr>
        <td colspan="5" class="paginacio">
            <div class="botonou">
                ...
                ?>
                <a href="{!! URL::to('/command/create/'.$botid.'?type=autoresponses') !!}" class="btn btn-success">{!! trans('front/dashboard.create_command') !!}</a>
                <?php
                }
                else{
                ?>
                <a href="{!! URL::to('/command/create/'.$botid.'?type=autoresponses&act=1') !!}" class="btn btn-success">{!! trans('front/dashboard.create_command') !!}</a>
                <?php
                }
                ?>
            </div>
