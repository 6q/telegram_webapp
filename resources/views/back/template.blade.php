            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    @if(session('statut') == 'admin')
                        ...
                        <li {!! classActiveSegment(1, 'user') !!} {!! classActiveSegment(1, 'bot') !!}>
						...
						<li {!! classActiveSegment(1, 'page') !!}>
                            <a href="#" data-toggle="collapse" data-target="#pagmenu"><span class="fa fa-fw fa-user"></span> {{ trans('back/admin.page') }} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="pagmenu" class="collapse">
                                <li><a href="{!! url('page') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                <li><a href="{!! url('page/create') !!}">{{ trans('back/admin.add') }}</a></li>
                            </ul>
                        </li>
						<li {!! classActiveSegment(1, 'emailtemplate') !!}>
                            <a href="#" data-toggle="collapse" data-target="#emailtemplate"><span class="fa fa-fw fa-user"></span> {{ trans('back/admin.emailtemplate') }} <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="emailtemplate" class="collapse">
                                <li><a href="{!! url('emailtemplate') !!}">{{ trans('back/admin.see-all') }}</a></li>
