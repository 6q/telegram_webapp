...
class HtmlBuilder
{
    ...
    public function linkImg($url, $title = null, $attributes = [], $secure = null)
    {
        $url = $this->url->to($url, [], $secure);
    ...
    public function linkRoute($name, $title = null, $parameters = [], $attributes = [])
    {
     ...
     public function linkRouteImg($name, $title = null, $parameters = [], $attributes = [])
    {
        return $this->linkImg($this->url->route($name, $parameters), $title, $attributes);
    }
